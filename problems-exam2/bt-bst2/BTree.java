...
public class BTree<T> {
   ...
   // Conta o número de filhos unicos da árvore
   public int count() {
      return count(root);
   }
   ...
   private int count(BTNode<T> n) {
      ...
      // Se for filho único
      if (n.getLeft() != null && n.getRight() == null || n.getRight() != null && n.getLeft() == null) {
   ...
   // retorna o nível mais próximo da raiz que é possível encontrar o v
   ...
   private void level(BTNode<T> n, T v, int cur, boolean[] contains) {
      if (n == null)
         return;
      if (n.getValue() == v)
         contains[cur] = true;
      level(n.getLeft(), v, cur + 1, contains);
      level(n.getRight(), v, cur + 1, contains);
   }
