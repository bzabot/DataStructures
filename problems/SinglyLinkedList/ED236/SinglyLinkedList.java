...
public class SinglyLinkedList<T> {
    ...
    public void shift(int k) {
        // Transformar numa lista circular
        if (isEmpty())
            return;
        Node<T> cur = first;
        ...
        cur.setNext(first); // O ultimo passa a apontar ao primeiro
        first = cur; // O first passa a apontar para o primeiro (antigo último)
        ...
        // Buscar o último nó e apontar ao primeiro

        // Buscar o nó na posição size-3 -1 (1, que é o nó com valor 2) e colocar numa
        // variável
        // first aponta para o nó seguinte da posição size-3-1
        // O nó salvo passa a apontar para null;
