public class TestSinglyLinkedList {
   public static void main(String[] args) {
      ...
      // Criacao de lista de vogais
      SinglyLinkedList<Pair> listVocal = new SinglyLinkedList<Pair>();

      // Escrevendo lista (no inicio esta vazia)
      System.out.println(listVocal);

      // Verificando se esta vazia
      System.out.println("isEmpty? " + listVocal.isEmpty());

      listVocal.addLast(new Pair(1, 2));
      listVocal.addLast(new Pair(3, 4));
